  ...
  <div class="row-fluid show-grid">
      <div class="span4">
        <div class="pad_bot2">
            ...
            <a href="" title="" class="avatar-sm-container"><img src="/uploads/fotos/s_<?php echo $info_usr_envioo['foto']?>" alt="<?php echo $info_usr_envioo['foto'] ?>" class="img-rounded user-avatar-sm"/></a>
            <?php endforeach; ?>
      </div>
      </div>
   </div>
