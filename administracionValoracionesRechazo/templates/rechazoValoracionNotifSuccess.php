...
<div class="wrapper">
     ...
     <!-- About Title -->
     <div class="title">
         <div class="divi1"></div><p class="title-spc">Atención</p><div class="divi1"></div>
     <div class="clear"></div>
          ...
          <br/><br/><br/><br/>
           <div class="bs-docs-example">
            <div class="alert alert-info">
              <center>
               <img src="/images/1408583078_accepted_48.png" alt="" height="30" width="30" /> Tu denuncia fue ingresada exitosamente, Gracias por tu aporte
              </center>
            </div>
           </div>
