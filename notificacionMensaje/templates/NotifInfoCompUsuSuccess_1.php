...
<div id="popup" class="popup">
	<a onclick="closeDialog('popup');" class="close"></a>
        ...
        <h4>
            ...
            <center>
                Estimad@ <?php echo $sf_user->getGuardUser()->getFirstName(); ?> <br/><br/>Tu anuncio ha sido creado satisfactoriamente
        ...
        <div class="bs-docs-example">
            <div class="alert alert-info">
              <center>
               ...
               anuncios de intercambios y/o donaci&oacute;nes podr&aacute;n localizarte mucho m&aacute;s r&aacute;pido
              </center>
            </div>
        </div>
            ...
            <form name="form1" id="planilla1" action="<?php echo url_for('notificacionMensaje/NotifInfoCompUsu')?>" method="post">
                <center>
                <input type="submit" value="Ingresar informacion complementaria" class="btn btn-success"/>
                </center>
            </form>
