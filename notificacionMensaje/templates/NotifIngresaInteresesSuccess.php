...
<div id="popup" class="popup">
	<a onclick="closeDialog('popup');" class="close"></a>
        ...
        <h4>
            ...
            <center>
                Estimad@ <?php echo $sf_user->getGuardUser()->getFirstName(); ?> <br/><br/>Tus intereses fueron ingresados<br/> satisfactoriamente
        ...
        <div class="bs-docs-example">
            <div class="alert alert-info">
              <center>
               Ahora todos conoceran tus intereses y que deseas a cambio por tus artículos<strong> :)</strong>
              </center>
            </div>
        </div>

        <form name="form1" id="planilla1" action="<?php echo url_for('notificacionMensaje/NotifIngresaIntereses')?>" method="post">
                <center>
