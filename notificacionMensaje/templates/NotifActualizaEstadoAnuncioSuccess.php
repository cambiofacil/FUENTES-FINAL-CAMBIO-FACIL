...
<div id="popup" class="popup">
	<a onclick="closeDialog('popup');" class="close"></a>
        ...
        <h4>
            ...
            <center>
                Estimad@ <?php echo $sf_user->getGuardUser()->getFirstName(); ?> <br/><br/>El estado de tu anuncio fue modificado <br/> satisfactoriamente
        ...
        <div class="bs-docs-example">
            <div class="alert alert-info">
              <center>
               Ahora se mostrar un bandera de color roja con la palabra "CAMBIADO"<br/> de esta forma los usuarios que estaban
               interesados en tu anuncio <br/>se daran por enterado que tu ya realizaste el intercambio <strong>de este artículo</strong>
              </center>
            </div>
        </div>
