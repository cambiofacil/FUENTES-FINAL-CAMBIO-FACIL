...
<div id="popup" class="popup">
	<a onclick="closeDialog('popup');" class="close"></a>
        ...
        <h4>
            ...
            <center>
                Estimad@ <?php echo $sf_user->getGuardUser()->getFirstName(); ?> <br/><br/>Tu valoración fue ingresada satisfactoriamente
        ...
        <div class="bs-docs-example">
            <div class="alert alert-info">
              <center>
               Las valoraciones entre usuarios es un proceso de vital importancia, ya que nos ayuda mantener una calificación
               para cada uno de los usuarios que realizan intercambios de esta forma puedes saber que tan confiable es el <strong> truqueador</strong>
              </center>
            </div>
        </div>
