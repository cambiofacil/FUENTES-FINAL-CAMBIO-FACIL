...
<div id="popup" class="popup">
	<a onclick="closeDialog('popup');" class="close"></a>
        ...
        <h4>
            ...
            <center>
                Estimad@ <?php echo $sf_user->getGuardUser()->getFirstName(); ?> <br/><br/>La casa de beneficencia ha sido creado satisfactoriamente
        ...
        <div class="bs-docs-example">
            <div class="alert alert-info">
              <center>
               Ahora todas las personas podrán conocer la información acerca de tu casa de beneficencia y sobre todo las necesidades primordiales
               para efectuar sus <strong>donaciones</strong>
              </center>
            </div>
        </div>
            
            <form name="form1" id="planilla1" action="<?php echo url_for('notificacionMensaje/NotifCreaCasaBenef')?>" method="post">
                <center>
