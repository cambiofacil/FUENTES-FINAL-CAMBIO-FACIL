...
<div class="wrapper">
  ...
  <div class="row-fluid show-grid">
      <div class="span8">
        ...
        <div class="row">
            <blockquote>
                <p>&bull; Comentarios realizados al anuncio # <?php echo $_GET['id']?></p>
            </blockquote>
                    ...
                    <div class="panel-group" id="accordion-cat-1">
                        <div class="panel panel-default panel-faq">
                            <div class="panel-heading">                                   
                                <div class="container">
                                    <?php foreach ($tituloo as $titulo): ?>
                                    <div class="page-header">
                                        <h1 id="timeline"><img src="/images/1376042442_advertisment.png" alt="" class="left marg_right1" height="30" width="30"/> <?php echo $titulo['titulo'] ?></h1>
                                    </div>
                                    <?php endforeach; ?>
                                    <?php foreach ($comentarioss as $comentarios): ?>

                                    <ul class="timeline">
                                        <li>
                                          <div class="timeline-badge info"><i class="icon-leaf icon-white hidden-phone"><br/><br/><?php echo $comentarios['id_comentarios'] ?></i></div>
                                          <div class="timeline-panel">
                                            <div class="timeline-heading">
                                                <table>
                                                    <tr>
                                                        <td><h4 class="timeline-title"><i class="icon-user"></i>

                                                        <a class='iframe_info_contacto' href="<?php echo url_for('informacionUsuario/index?id_usr_contacto='.$comentarios['id'])?>"><strong><?php echo $comentarios['first_name'] ?> <?php echo $comentarios['last_name'] ?></strong></a>

                                                            </h4></td>
                                                        <td>&nbsp;&nbsp;</td>
                                                        <td>(<?php echo $comentarios['nombre_prov'] ?> - <?php echo $comentarios['nombre_cant'] ?>)</td>
                                                    </tr>
                                                </table>
                                            </div>
                                            <div class="timeline-body">
                                                  <div class="cntc" id="contact_form" >
                                                    <form id="contactform" class="form-contact"  action="mailer.php" method="post">
                                                        <table class="table table-striped table-bordered">
                                                            <tr>
                                                                <td><?php echo $comentarios['cometario'] ?></td>
                                                            </tr>
                                                        </table>
                                              ...
                                              <p><i class="icon-edit"></i> (<?php echo $comentarios['email_address'] ?>)</p>
                                              <p align="right"><i class="icon-calendar"></i> <?php echo $comentarios['fecha_comenta'] ?></p>
                                            </div>
                                          </div>
                                        </li>
                                    </ul>
