...
<!-- Page Title -->
<?php slot('title') ?>
<?php echo sprintf('cambiar.com | Donaciones')?>
<?php end_slot(); ?>
...
<div class="wrapper">
     ...
     <!-- About Title -->
     <div class="title">
     <div class="divi1"></div><p class="title-spc">Casa de Beneficencia</p><div class="divi1"></div>
     <div class="clear"></div>
      ...
      <div class="span4">
        <div class="pad_bot2">
            ...
            <table class="table table-striped table-bordered">
                <tr>
                    <td><center><img src="/images/img_baner_cb.png" alt="" class="left marg_right1"/></center></td>
                </tr>
            </table>
        </div>
      </div>
