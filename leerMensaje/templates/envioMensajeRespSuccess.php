  ...
  <div class="row-fluid show-grid">
        ...
        <div class="pad_bot2">
            ...
            <div class="alert alert-info">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">
                    ×</button>
                <span class="glyphicon glyphicon-info-sign"></span> <strong><center><?php echo $anuncios['nombre_usu_envia']?> <br/><br/><a href="/uploads/fotos/<?php echo $anuncios['foto']?>" alt="<?php echo $anuncios['foto'] ?> " rel="lightbox[galeria1]" title="Haz click"><img src="/uploads/fotos/<?php echo $anuncios['foto']?>" alt="<?php echo $anuncios['foto'] ?> " width="70" height="60"/></a></center></strong>
                <hr class="message-inner-separator">
                <p>
                    <strong>Localidad:</strong><br/>
                         <?php echo $anuncios['provincia_usu_envia']?> -
                         <?php echo $anuncios['ciudad_usu_envia']?><br/><br/>
                         <strong>Correo:</strong><br/>
                         <?php echo $anuncios['email_usu_envia']?><br/><br/>
                         <strong>Teléfonos:</strong><br/>
                         <?php echo $anuncios['nro_celular']?>/
                         <?php echo $anuncios['nro_convencional']?>/
                         <?php echo $anuncios['nro_oficina']?><br/><br/>
                         <strong>Nacionalidad:</strong><br/>
                         <?php echo $anuncios['nacionalidad']?><br/><br/>
                         <strong>Ocupación:</strong><br/>
                         <?php echo $anuncios['ocupacion']?>
                </p>
            </div>
        </div>
            <?php endforeach; ?>
      ...
      <div class="span8">
        ...
        <table class="table table-striped table-bordered">
             ...
             <tbody>
                 <tr>
                     <td>
                         <center>
                         <?php foreach ($listaMSJ as $listaMSJJ): ?>
                         <div class="badger-right badger-info" data-badger="<?php echo $listaMSJJ['nombre_usu_envia']?> <?php echo $listaMSJJ['apellido_usu_envia']?>">
                         <textarea name="mensaje" cols="15" rows="3" id="mensaje" style="background-color: transparent;border: 1px solid #000000;scrollbar-arrow-color: #000066;scrollbar-base-color: #000033;scrollbar-dark-shadow-color: #336699;scrollbar-track-color: #666633;scrollbar-face-color: #cc9933;scrollbar-shadow-color: #DDDDDD;scrollbar-highlight-color: #CCCCCC;" readonly><?php echo $listaMSJJ['mensaje']?>...</textarea>
                         <blockquote class="pull-right">
                         <small><i class="icon-envelope"></i> <cite title="Source Title"><?php echo $listaMSJJ['fecha']?></cite></small>
                         </blockquote>
                         </div>
                         <?php endforeach; ?>
                         </center>
        ...
        <form name="form1" id="planilla1" action="<?php echo url_for('leerMensaje/index')?>" method="post">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;<strong>Escribe tu mensaje</strong>
