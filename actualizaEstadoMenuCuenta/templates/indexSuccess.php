...
<section id="fluidGridSystem">
  <div class="row-fluid show-grid">
      <div class="span8">
        ...
        <form name="form1" id="planilla1" action="<?php echo url_for('actualizaEstadoMenuCuenta/index')?>" method="post">
            ...
            <table class="table table-striped table-bordered">
                <tr>
                    <td><strong><center><i class="icon-refresh"></i> Nuevo estado:
                                <select class="selectpicker" name="new_estado" id="new_estado">
