...
<div class="wrapper">
    ...
    <!-- About Title -->
     <div class="title">
     <div class="divi1"></div><p class="title-spc">Valoraciónes Denunciadas</p><div class="divi1"></div>
     <div class="clear"></div>
...
<section id="fluidGridSystem">
	...
	$(document).ready(function() {
		...
		chart = new Highcharts.Chart({
			...
			title: {
				text: 'Reporte de valoraciones denunciadas'	// Titulo (Opcional)
			},
			pane: {
                        startAngle: -150,
                        endAngle: 150,
        ...
        series: [{
            name: 'Cantidad',
            <?php foreach ($nro_valorac_denun as $nro_valorac_denunn): ?>
            data: [<?php echo $nro_valorac_denunn['nrovaloraciones']?>],//valor a mostrar en el velocimetro
            <?php endforeach; ?>
            tooltip: {
                valueSuffix: ' valoraciones'
            }
        }]
    ...
    <table class="table table-striped table-bordered">
              <thead>
                  <tr>
                      ...
                      <th><center>Referencia 1</center></th>
                      <th><center>Referencia 2</center></th>
                      <th><center>Usuario Ingresa</center></th>
                      <th><center>Fecha</center></th>
                  </tr>
             </thead>
             <tbody>
                 <?php $cont = 1; ?>
                 <?php foreach ($msj_denunciados as $msj_denunciadoss): ?>
                 <tr>
                    <td><center><?php echo $cont++ ?></center></td>
                    <td><center><?php echo $msj_denunciadoss['id_incidente_det']?></center></td>
                    <td><center><span class="label label-warning"><?php echo $msj_denunciadoss['id_referencia_pri']?></span></center></td>
                    <td><center><span class="label label-info"><?php echo $msj_denunciadoss['id_referencia_sec']?></span></center>
                                </td>
                    <td><center><?php echo $msj_denunciadoss['first_name']?> <?php echo $msj_denunciadoss['last_name']?></center></td>
                    <td><center><?php echo $msj_denunciadoss['fecha_incid_det']?></center></td>
                 </tr>
                 <?php endforeach; ?>
            </tbody>
    </table>
