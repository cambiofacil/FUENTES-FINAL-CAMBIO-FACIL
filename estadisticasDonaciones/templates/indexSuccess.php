      ...
      <div class="span8">
        ...
        <div class="row">
            ...
            <ul class="nav nav-tabs faq-cat-tabs">
                ...
                <li><a href="#faq-cat-2" data-toggle="tab">Descripción de Donaciones</a></li>
            </ul>
                                ...
                                <table class="table table-striped table-bordered">
                                          ...
                                          <tr>
                                              ...
                                              <td><?php if($donac_realizaa['estado_donac_cab'] == 0){?>
                                                  <center><br/><a  href="<?php echo url_for('detalleDonacion/index?id_fic_cab='.$donac_realizaa['id_fich_cab'])?>" ><font color="green"><?php echo 'Donación realizada'?></font></a><br/>
                                                          <img src="/images/1408583078_accepted_48.png" alt="" height="30" width="30" />
                                                  </center>
                                                  <?php }?>
                                                  <?php if($donac_realizaa['estado_donac_cab'] == 1){?>
                                                  <center><br/>
                                                      <font color="blue"><a href="<?php echo url_for('fichaDonacionDetGuarda/index?id_fich_cb='.$donac_realizaa['id_fich_cab']) ?>" title="click para ingresar detalle de ficha de donación"><?php echo 'Donación pendiente'?></a></font><br/>
