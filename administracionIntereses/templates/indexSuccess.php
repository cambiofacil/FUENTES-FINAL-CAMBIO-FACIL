...
<div class="wrapper">
     ...
     <!-- About Title -->
     <div class="title">
     <div class="divi1"></div><p class="title-spc">Administración de Intereses</p><div class="divi1"></div>
     <div class="clear"></div>
  ...
  <div class="row-fluid show-grid">
      <div class="span8">
        ...
        <table>
        <tr>
            <td><center><h2><center> <img src="/images/intereses.png" alt="" width="50" height="50" title="Haz click"/> Intereses</center></h2></center></td>
        </tr>
        </table>
        ...
        <div class="row">
            ...
            <p><em>Los intereses son la forma más rápida de dar a conocer a todas las personas que están
                    interesadas en intercambiar artículos contigo y así gestionar truques mucho más rápido.</em></p>
            <blockquote class="pull-right">
            <small><cite title="Source Title">camb!o fác¡l</cite></small>
            </blockquote>
            <br/><br/>

            <a href="<?php echo url_for('interesesUsuarios/index') ?>" title="Elegir intereses"><img src="/images/intereses.png" alt="" width="15" height="15" class="left" /> Ingresar nuevo interes</a>
            ...
            <table class="table table-striped table-bordered">
                                     ...
                                     <tbody>
                                         <?php $var = 1; ?>
                                         <?php foreach ($int_usr as $int_usrr): ?>
                                         <tr>
                                            <td><center><?php echo $var++ ?></center></td>
                                            <td><?php echo $int_usrr['nombre_cat']?></td>
                                            <td><?php echo $int_usrr['descripcion_cat']?></td>
                                         </tr>
                                         <?php endforeach; ?>
