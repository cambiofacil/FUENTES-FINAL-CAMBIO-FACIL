...
<table class="table table-striped table-bordered">
  ...
  <tbody>
    <?php foreach ($apcategorias as $apcategoria): ?>
    <tr>
      <td><a href="<?php echo url_for('nuevaCategoria/edit?id_categoria='.$apcategoria->getIdCategoria()) ?>"><?php echo $apcategoria->getIdCategoria() ?></a></td>
      <td><?php echo $apcategoria->getNombreCat() ?></td>
      <td><?php echo $apcategoria->getEstadoCat() ?></td>
      <td><?php echo $apcategoria->getDescripcionCat() ?></td>
      <td><?php echo $apcategoria->getImagen() ?></td>
    </tr>
    <?php endforeach; ?>
  </tbody>
</table>

  <a href="<?php echo url_for('nuevaCategoria/new') ?>">Nuevo</a>
