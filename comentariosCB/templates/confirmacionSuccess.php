...
<div class="wrapper">
     ...
     <!-- About Title -->
     <div class="title">
         <div class="divi1"></div><p class="title-spc">Confirmación</p><div class="divi1"></div>
     <div class="clear"></div>
...
<section id="fluidGridSystem">
  <div class="row-fluid show-grid">
      <div class="span4">
        <div class="pad_bot2">
            <br/><br/><br/><br/>
            <center>Estimad@ <?php echo $sf_user->getGuardUser()->getFirstName(); ?> <?php echo $sf_user->getGuardUser()->getLastName(); ?></center>
            <br/><br/>
           <div class="bs-docs-example">
            <div class="alert alert-info">
              <center>
               <img src="/images/1408583078_accepted_48.png" alt="" height="30" width="30" /> Su comentario fue ingresado correctamente.
              </center>
            </div>
           </div>
       </div>
