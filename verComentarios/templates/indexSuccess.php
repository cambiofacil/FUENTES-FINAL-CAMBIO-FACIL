...
<div class="wrapper">
  ...
  <div class="row-fluid show-grid">
      <div class="span8">
        ...
        <div class="row">
            <blockquote>
                <p>&bull; Comentarios realizados a tus anuncios</p>
            </blockquote>
            ...
            <ul class="nav nav-tabs faq-cat-tabs">
                <li class="active"><a href="#faq-cat-1" data-toggle="tab">Time line</a></li>
                <li><a href="#faq-cat-2" data-toggle="tab">Estilo tabla</a></li>
            </ul>
                    ...
                    <div class="panel-group" id="accordion-cat-1">
                        <div class="panel panel-default panel-faq">
                            <div class="panel-heading">
                                <div class="container">
                                    <?php foreach ($coment_todos as $coment_todoss): ?>                                        
                                        <h4 id="timeline"><img src="/images/1376042442_advertisment.png" alt="" class="left marg_right1" height="30" width="30"/> <?php echo $coment_todoss['titulo1'] ?></h4>
                                        
                                        <ul class="timeline">
                                        <li>
                                          <div class="timeline-badge info"><i class="icon-leaf icon-white hidden-phone"><br/><br/><?php echo $coment_todoss['id_anuncio1'] ?></i></div>
                                          <div class="timeline-panel">
                                                ...
                                                <table>
                                                    <tr>
                                                        <td><h4 class="timeline-title"><i class="icon-user"></i> 
                                                            ...
                                                            <a class='iframe_info_contacto' href="<?php echo url_for('informacionUsuario/index?id_usr_contacto='.$coment_todoss['id'])?>"><strong><?php echo $coment_todoss['first_name1'] ?> <?php echo $coment_todoss['last_name1'] ?></strong></a>

                                                            </h4></td>
                                                        <td>&nbsp;&nbsp;</td>
                                                        <td>(<?php echo $coment_todoss['nombre_prov1'] ?> - <?php echo $coment_todoss['nombre_cant1'] ?>)</td>
                                                    </tr>
                                                </table>
                                            </div>
                                            <div class="timeline-body">
                                                  <div class="cntc" id="contact_form" >
                                                    <form id="contactform" class="form-contact"  action="mailer.php" method="post">
                                                        <table class="table table-striped table-bordered">
                                                            <tr>
                                                                <td><?php echo $coment_todoss['cometario1'] ?></td>
                                                            </tr>
                                                        </table>
                                              ...
                                              <p><i class="icon-edit"></i> (<?php echo $coment_todoss['email_address1'] ?>)</p>
                                              <p align="right"><i class="icon-calendar"></i> <?php echo $coment_todoss['fecha_comenta1'] ?></p>
                                            </div>
                                          </div>
                                        </li>
                                    </ul>
                            ...
                            <div class="panel-heading">
                                    ...
                                    <table class="table table-striped table-bordered">
                                        <tr>
                                            ...
                                            <td><center><strong>Anuncio</strong></center></td>
                                            <td><center><strong>Comentario</strong></center></td>
                                            <td><center><strong>Fecha</strong></center></td>
                                            <td><center><strong>Usuario Comentó</strong></center></td>
                                        <tr>
                                        <?php $cont = 1 ?>
                                        <?php foreach ($coment_todos as $coment_todoss): ?>
                                        <tr>
                                            <td><?php echo $cont++ ?></td>
                                            <td><?php echo $coment_todoss['titulo1'] ?><br/>
                                                <img alt="<?php echo $coment_todoss['titulo1']?>" class="img-polaroid" src="/uploads/fotos/<?php echo $coment_todoss['imagen_p1']?>" width="50" height="50" />
                                                <img alt="<?php echo $coment_todoss['titulo1']?>" class="img-polaroid" src="/uploads/fotos/<?php echo $coment_todoss['imagen_s1']?>" width="50" height="50" />
                                                <img alt="<?php echo $coment_todoss['titulo1']?>" class="img-polaroid" src="/uploads/fotos/<?php echo $coment_todoss['imagen_t1']?>" width="50" height="50" /></td>
                                            <td>
                                            <center>
                                                <textarea name="mensaje" cols="15" rows="2" id="mensaje" style="background-color: transparent;border: 1px solid #000000;scrollbar-arrow-color: #000066;scrollbar-base-color: #000033;scrollbar-dark-shadow-color: #336699;scrollbar-track-color: #666633;scrollbar-face-color: #cc9933;scrollbar-shadow-color: #DDDDDD;scrollbar-highlight-color: #CCCCCC;" readonly><?php echo $coment_todoss['cometario1'] ?></textarea>
                                            </center>
                                            </td>
                                            <td><?php echo $coment_todoss['fecha_comenta1'] ?></td>
                                            <td><i class="icon-user"></i> <?php echo $coment_todoss['first_name1'] ?> <?php echo $coment_todoss['last_name1'] ?><br/>
                                                <i class="icon-envelope"></i> <?php echo $coment_todoss['email_address1'] ?><br/>
                                                <i class="icon-map-marker"></i><?php echo $coment_todoss['nombre_prov1'] ?> - <?php echo $coment_todoss['nombre_cant1'] ?></td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </table>
