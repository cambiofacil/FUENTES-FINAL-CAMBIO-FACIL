        ...
        <?php if ($usr_info_comm['resulta'] == 0){ ?>
            ...
            <div class="bs-docs-example">
                <div class="alert alert-info">
                  <center>
                   <font size="4">Tienes problemas para publicar tus anuncios..? Te recomendamos que primero completes tu información
                   del perfil, este es un proceso obligatorio para todos los usuarios, de esta forma garantizamos
                   a toda la comunidad de truequeadores encontrar información real en cada uno de los perfiles
                   que desean intercambiar objetos, favores e información.</font>
                   <br/><br/>
                   <center><a href="<?php echo url_for('informacionUsuario/new') ?>"><font size="6"> Haz click para completar tu información del perfil &raquo;</font></a></center>
                  </center>
                </div>
            </div>
