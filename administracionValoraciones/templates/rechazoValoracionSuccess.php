...
<div class="wrapper">
     ...
     <!-- About Title -->
     <div class="title">
         <div class="divi1"></div><p class="title-spc">Rechazar Valoración</p><div class="divi1"></div>
     <div class="clear"></div>
...
<section id="fluidGridSystem">
  <div class="row-fluid show-grid">
      <div class="span4">
        <div class="pad_bot2">
            <br/><br/>
            <form name="form1" id="planilla1" action="<?php echo url_for('administracionValoraciones/rechazoValoracion')?>" method="post">
            
            <input type="tex" id="ref_pri" name="ref_pri" value="<?php echo $_GET['id_valoracion_det']?>"/>
            
            <center><input type="submit" value="Notificar inconveniente" class="btn btn-success" title="Haz click"/></center>
            </form>
            <br/><br/>
           <div class="bs-docs-example">
            <div class="alert alert-info">
              <center>
               Has considerado que esta voloración no es la adecuada, gracias por notificar estos problemas,
               en pocos segundos nuestro equipo de cambiofacil.com analizara tu requerimiento y eliminara esta
