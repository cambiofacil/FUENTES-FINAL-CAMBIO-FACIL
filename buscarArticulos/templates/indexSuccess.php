...
<section id="fluidGridSystem">
  <div class="row-fluid show-grid">
      <div class="span4">
        <div class="pad_bot2">
          ...
          <?php endif ?>
            ...
            <h2>&raquo; <small>FILTROS</small></h2>
            <form name="form1" id="planilla1" action="<?php echo url_for('anunciosFilroCiudad/index')?>" method="get">
                <select class="form-control" name="id_cat" id="id_cat_fil">
                ...
                <select class="form-control" name="ciudad" id="ciudad_fil">
                ...
                <select class="form-control" name="estado" id="estado_fil">
    ...
    <table class="table table-striped table-bordered">
            <tr>
                <td colspan="4"><img src="/images/1376042442_advertisment.png" alt="" height="30" width="30"/>  <strong><a href="<?php echo url_for('verPerfil/index?username='.$pagerr['usernamee'].'&id='.$pagerr['id_usr'].'&idanuncio='.$pagerr['id_anun'])?>"><font color="black"><?php echo $pagerr['titulo_anun']?></font></a></strong> (Cod # <?php echo $pagerr['id_anun']?>)<div class="contcinta">
    ...
    <?php echo link_to('<img src="/images/1409971152_Fast-forward_1.png" alt="" />', 'buscarArticulos/index?page='.$pager->getFirstPage()) ?>
    <?php echo link_to('<img src="/images/1409971241_Go_2.png" alt="" />', 'buscarArticulos/index?page='.$pager->getPreviousPage()) ?>

    <?php $links = $pager->getLinks();?>
    <?php endif ?>

    <?php foreach ($links as $page): ?>
    <span class="label"><?php echo ($page == $pager->getPage()) ? $page : link_to($page, 'buscarArticulos/index?page='.$page) ?></span>
    <?php endforeach; ?>

    <?php echo link_to('<img src="/images/1409971241_Go.png" alt="" />', 'buscarArticulos/index?page='.$pager->getNextPage()) ?>
    <?php echo link_to('<img src="/images/1409971152_Fast-forward.png" alt="" />', 'buscarArticulos/index?page='.$pager->getLastPage()) ?>
    </ul>
    </div>
