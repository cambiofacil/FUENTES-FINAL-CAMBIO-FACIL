  ...
  <div class="row-fluid show-grid">
      <div class="span4">
        <div class="pad_bot2">
            ...
            <br/><br/><strong>Activo:</strong> esto indica que tu artículo está disponible para un truque.
            <br/><strong>Cambiado:</strong> esto indica que ya realizaste un intercambio y no lo tienes a disposición de un trueque, tu anuncio se mostrara con una bandera roja que indica que tu artículo ya fue cambiado.
            <br/><strong>Inactivo:</strong> esto indica que ya no deseas realizar un intercambio con este artículo o talvez lo diste en donación, tu anuncio no aparecerá en la sección de anuncios
                </em></p>
      ...
      <div class="span8">
          <div class="span10">
        <h2>Cambio de estado anuncio</h2>
