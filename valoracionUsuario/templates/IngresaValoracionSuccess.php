  ...
  <div class="row-fluid show-grid">
      <div class="span8">
          <div class="span10">
           ...
           <form name="form2" id="planilla2" action="<?php echo url_for('valoracionUsuario/index')?>" method="post">
              ...
              <table class="table table-striped table-bordered">
                  <tr>
                      <td>
                          <strong>Valoraci&oacute;n /100</strong>
                      </td>
                  </tr>
                  <tr>
                      <td><center><img src="/images/0.png" alt="" class="left marg_right1" height="40" width="40"/><br/><input type="radio" name="val" value="0"> 0</center></td>
                      <td><center><img src="/images/25.png" alt="" class="left marg_right1" height="40" width="40"/><br/><input type="radio" name="val" value="25"> 25</center></td>
                      <td><center><img src="/images/50.png" alt="" class="left marg_right1" height="40" width="40"/><br/><input type="radio" name="val" value="50"> 50</center></td>
                      <td><center><img src="/images/75.png" alt="" class="left marg_right1" height="40" width="40"/><br/><input type="radio" name="val" value="75"> 75</center></td>
                      <td><center><img src="/images/100.png" alt="" class="left marg_right1" height="40" width="40"/><br/><input type="radio" name="val" value="100" checked="true"> 100</center></td>
                  </tr>
                  <tr>
                      <td colspan="5"><br/><center><input type="submit" value="Guardar Valoración" class="btn btn-success"/></center></td>
                  </tr>
              </table>
           </form>
