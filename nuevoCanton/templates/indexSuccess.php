...
<table class="table table-striped table-bordered">
  <thead>
    <tr>
      <th><center>Id canton</center></th>
      <th><center>Id provincia</center></th>
      <th><center>Nombre canton</center></th>
    </tr>
  </thead>
  <tbody>
    <?php foreach ($apcantoness as $apcantones): ?>
    <tr>
      <td><a href="<?php echo url_for('nuevoCanton/edit?id_canton='.$apcantones->getIdCanton()) ?>"><?php echo $apcantones->getIdCanton() ?></a></td>
      <td><?php echo $apcantones->getIdProvincia() ?></td>
      <td><?php echo $apcantones->getNombreCant() ?></td>
    </tr>
    <?php endforeach; ?>
  </tbody>
</table>

  <a href="<?php echo url_for('nuevoCanton/new') ?>">Nuevo</a>
