  ...
  <div class="row-fluid show-grid">
      <div class="span8">
        ...
        <div class="row">
            ...
            <p><em>Las medallas por donaciones fueron creadas como incentivo para los usuarios que realizan donaciones para las casas de beneficencia. Las medallas son entregadas a
                    los donadores mediante la cantidad de donaciones que han realizado.</em></p>
            ...
            <div class="tab-content faq-cat-content">
             ...
             <tbody>
                 ...
                 <?php foreach ($medallas_catalogo as $medallas_catalogoo): ?>
                 <tr>
                     <td><center>
                     <strong><?php echo $medallas_catalogoo['id_catalogo_medall']?></strong>
                     </center>
                     </td>
                     <td><center><img alt="" class="img-polaroid" src="/uploads/fotos/<?php echo $medallas_catalogoo['nombre_medall']?>" width="80" height="80" /></center></td>
                     <td><?php echo $medallas_catalogoo['descripcion_medall']?></td>
                     <td><center><?php echo $medallas_catalogoo['cant_donaciones']?></center></td>
                 </tr>
                 <?php endforeach; ?>
